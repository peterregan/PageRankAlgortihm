public class PageRankMain {
    ...
    static final int PAGES = 100; // number of pages or vertices
    static final int LINKS = 500; // number of links or edges
    static final long SEED = 2; // number to change the randomness of what vertices the edges go to and from
